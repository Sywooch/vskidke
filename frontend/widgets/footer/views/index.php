...
<div class="modal-container">
    ...
    <div id="contact-modal" class="modal-layout-wrapp">
        <div class="modal-layout">
            <div class="close"></div>
            <div class="modal-title">Контакты</div>
            <p>E-mail: info@vskidke.com</p>
        </div>
    </div>

    <div id="about-modal" class="modal-layout-wrapp">
        <div class="modal-layout">
            <div class="close"></div>
            <div class="modal-title">О проекте</div>
            <p>В жизни каждого из нас наступает момент, когда мы хотим приобрести нужный товар или воспользоватьсяуслугой, но при этом катастрофически не хватает времени на поиски выгодных предложений.</p>
            <p>Именно поэтому мы и создали наш проект Vskidke.com. На нашем сайте Вы сможете просмотреть актуальную информацию обо всех действующих скидках в своём городе.</p>
            <p>А если вдруг Вы не нашли то, что искали, Вы всегда сможете «заказать свою скидку» - ту, о которой сейчас мечтаете. А мы, в свою очередь, сделаем всё возможное, чтобы Вас услышали. Ведь мечты должны сбываться)</p>
            <p>Оставайтесь всегда с нами!</p>
            <p>Регистрируйтесь на сайте, смотрите скидки, лайкайте, пишите отзывы, делитесь информацией сдрузьями в социальных сетях, а также приглашайте их к нам на сайт и получайте за это бонусы, которые легко обменять на интересные подарки.</p>
            <p>Сделайте свою жизнь ярче, а покупки – выгоднее вместе с нами!</p>
        </div>
    </div>
